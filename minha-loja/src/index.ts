...
import { ClientePessoaFisica } from './ClientePessoaFisica.js';
import { ClientePessoaJuridica } from './ClientePessoaJuridica.js';

console.log("--- Iniciando Sistema de E-Commerce ---");

// Criando instância de Clientes
const clientePF = new ClientePessoaFisica(1, "carlos@email.com", "Carlos Ferreira", "123.456.789-09");
const clientePJ = new ClientePessoaJuridica(2, "contato@empresa.com", "Empresa XPTO", "12.345.678/0001-99");

console.log("\n--- Clientes Cadastrados ---");
console.log(clientePF);
console.log(`Email do cliente PJ: ${clientePJ.email}`);
...
const clienteInvalido1 = new ClientePessoaFisica(3, "A", "ana@email.com", "123");

console.log("Tentando criar cliente com email inválido:");
const clienteInvalido2 = new ClientePessoaFisica(4, "Beatriz", "beatrizemail.com", "123");

console.log("Tentando alterar para um nome inválido:");
const clienteValido = new ClientePessoaJuridica(5, "edu@email.com", "Empresa ABCD", "123.456.789/0001-00");
console.log(`\nNome Original: ${clienteValido.razaoSocial}`);

clienteValido.razaoSocial = "E";
console.log(`\nNome depois de tentar alterar: ${clienteValido.razaoSocial}`);
...
const pedidoRecriado = Pedido.fromData(dadosDoServidor, clientePF);
...
const clienteOriginal = new ClientePessoaFisica(10, "joana@email.com", "Joana Silva", "999.999.999-99");
const jsonCliente = JSON.stringify(clienteOriginal.toJSON(), null, 2);
console.log("Cliente serializado:");
console.log(jsonCliente);

// const clienteRecriado = ClientePessoaFisica.fromJSON(jsonCliente);
